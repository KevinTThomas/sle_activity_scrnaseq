...
# Define variables
file_directory <- "~/workspace/datasets/disease_activity/droplets"
dataDirs <- list.files(
  path = file_directory,
...
saveRDS(object = pre_qc, file = "../data/pre_qc.RDS")
saveRDS(object = gem_classification, file = "../data/gem_classification.RDS")
```
